...
{
	internal class MissingDuplicateComponentsRemover : AsSearchers
	{
		...
		private void RemoveMissingScripts()
		{
			...
			if (searchPrefab) FindFiles(SearchPrefabs, "Searching Prefabs", "*.prefab");
			if (searchScene) FindFiles(SearchScenes, "Searching Scenes", "*.unity");
