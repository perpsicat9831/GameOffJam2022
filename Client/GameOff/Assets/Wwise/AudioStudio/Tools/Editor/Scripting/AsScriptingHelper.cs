...
namespace AudioStudio.Tools
{
    public static class AsScriptingHelper
    {
        #region XML
        //-----------------------------------------------------------------------------------------
        public static void WriteXml(string filePath, XElement xRoot)
        {
            CheckoutLockedFile(filePath);
        ...
        /// <summary>
        /// Cut the path format to meet the requirements.
        /// </summary>
        /// <param name="longPath"></param>
        /// <param name="includeAssetsPrefix"></param>
        /// <returns></returns>
        ...
        #region Json
        public static string FromJson(string jsonString, string fieldName)
        {
            ...
            var value = jsonString.Substring(indexStart, length);
